...
- 从排序质量看，hybrid_weightsum 更好 在 MRR@10 上表现更强，weightsum=0.6585，rrf=0.6507。
...
- compare 类型上，Recall@10 两种方法持平，weightsum=0.9500，rrf=0.9500；MRR@10 hybrid_weightsum 更好，weightsum=0.3008，rrf=0.2783。
- summary 类型上，Recall@10 hybrid_weightsum 更好，weightsum=0.7000，rrf=0.6000；MRR@10 hybrid_weightsum 更好，weightsum=0.1614，rrf=0.1351。

## Experiment Record

- 运行时间戳: 20260601_233756
...
- chunk 文本截断: 不截断
- 输出目录: `/home/txs/work/zyp/RAG/output/decompose_1`
- hybrid_weightsum 耗时: 1328.97s
- hybrid_rrf 耗时: 1314.50s
- hybrid_weightsum JSON: `eval_hybrid_weightsum__rerank_on__qd_on__20260601_233756.json`
- hybrid_rrf JSON: `eval_hybrid_rrf__rerank_on__qd_on__20260601_233756.json`
- hybrid_weightsum 阅读版: `eval_hybrid_weightsum__rerank_on__qd_on__20260601_233756__readable.md`
- hybrid_rrf 阅读版: `eval_hybrid_rrf__rerank_on__qd_on__20260601_233756__readable.md`
