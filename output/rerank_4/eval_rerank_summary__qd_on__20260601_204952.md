...
| --- | --- | --- | --- | --- | --- | --- |
| hybrid_weightsum | 125 | 0.7200 | 0.8480 | 0.8800 | 0.6426 | 0.8387 |
| hybrid_rrf | 125 | 0.7040 | 0.8240 | 0.8640 | 0.6357 | 0.8384 |
...
| hybrid_weightsum | compare | 20 | 0.5500 | 0.8500 | 0.9500 | 0.2913 | 0.8074 |
| hybrid_weightsum | summary | 20 | 0.0500 | 0.2500 | 0.3000 | 0.0713 | 0.7287 |
| hybrid_rrf | fact | 85 | 0.9176 | 0.9882 | 1.0000 | 0.8596 | 0.8714 |
| hybrid_rrf | compare | 20 | 0.4500 | 0.7500 | 0.9000 | 0.2617 | 0.7744 |
| hybrid_rrf | summary | 20 | 0.0500 | 0.2000 | 0.2500 | 0.0579 | 0.7622 |

## Analysis

- 总体上，hybrid_weightsum 更好 在 Recall@10 上更占优，weightsum=0.8800，rrf=0.8640。
- 从排序质量看，hybrid_weightsum 更好 在 MRR@10 上表现更强，weightsum=0.6426，rrf=0.6357。
...
- compare 类型上，Recall@10 hybrid_weightsum 更好，weightsum=0.9500，rrf=0.9000；MRR@10 hybrid_weightsum 更好，weightsum=0.2913，rrf=0.2617。
- summary 类型上，Recall@10 hybrid_weightsum 更好，weightsum=0.3000，rrf=0.2500；MRR@10 hybrid_weightsum 更好，weightsum=0.0713，rrf=0.0579。

## Experiment Record

- 运行时间戳: 20260601_204952
...
- chunk 文本截断: 不截断
- 输出目录: `/home/txs/work/zyp/RAG/output/rerank_4`
- hybrid_weightsum 耗时: 1406.52s
- hybrid_rrf 耗时: 1369.78s
- hybrid_weightsum JSON: `eval_hybrid_weightsum__rerank_on__qd_on__20260601_204952.json`
- hybrid_rrf JSON: `eval_hybrid_rrf__rerank_on__qd_on__20260601_204952.json`
- hybrid_weightsum 阅读版: `eval_hybrid_weightsum__rerank_on__qd_on__20260601_204952__readable.md`
- hybrid_rrf 阅读版: `eval_hybrid_rrf__rerank_on__qd_on__20260601_204952__readable.md`
