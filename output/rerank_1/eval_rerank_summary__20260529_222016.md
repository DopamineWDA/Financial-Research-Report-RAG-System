...
- 总体上，hybrid_weightsum 更好 在 Recall@10 上更占优，weightsum=0.5520，rrf=0.5280。
- 从排序质量看，hybrid_weightsum 更好 在 MRR@10 上表现更强，weightsum=0.4086，rrf=0.4049。
- 按类型拆分时，建议重点看 compare 和 summary，因为这两类题必须满足跨组件联合命中，能更直接反映 rerank 后的多证据覆盖能力。
- fact 类型上，Recall@10 hybrid_weightsum 更好，weightsum=0.7529，rrf=0.7176；MRR@10 hybrid_weightsum 更好，weightsum=0.5838，rrf=0.5788。
- compare 类型上，Recall@10 两种方法持平，weightsum=0.2000，rrf=0.2000；MRR@10 hybrid_weightsum 更好，weightsum=0.0558，rrf=0.0542。
- summary 类型上，Recall@10 两种方法持平，weightsum=0.0500，rrf=0.0500；MRR@10 两种方法持平，weightsum=0.0167，rrf=0.0167。

## Experiment Record

- 运行时间戳: 20260529_222016
...
- chunk 文本截断: 不截断
- 输出目录: `/home/txs/work/zyp/RAG/output/rerank_1`
- hybrid_weightsum 耗时: 934.82s
- hybrid_rrf 耗时: 926.83s
- hybrid_weightsum JSON: `eval_hybrid_weightsum__rerank_on__20260529_222016.json`
- hybrid_rrf JSON: `eval_hybrid_rrf__rerank_on__20260529_222016.json`
- hybrid_weightsum 阅读版: `eval_hybrid_weightsum__rerank_on__20260529_222016__readable.md`
- hybrid_rrf 阅读版: `eval_hybrid_rrf__rerank_on__20260529_222016__readable.md`
