...
def parse_args() -> argparse.Namespace:
    ...
    default_input = repo_root / "data_chunked" / "chunked_512_50"
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="/home/txs/.cache/huggingface/hub/models--BAAI--bge-large-zh-v1.5",
...
def main() -> None:
    ...
    if args.output_dir is None:
        ...
        args.output_dir = repo_root / "indexes" / f"faiss_{args.index_type}_{input_suffix}_bge-large-zh-v1.5"
    else:
