...
12. 如果涉及到数字/指标等有单位的输出，必须查看证据明确数值的单位，并在必要的时候进行换算回答问题。
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--index-dir", type=Path, default=REPO_ROOT / "indexes" / "faiss_hnsw_chunked_512_50_bge-large-zh-v1.5")
    parser.add_argument("--endpoint", default="http://127.0.0.1:9997", help="Xinference endpoint base URL or full chat completions URL.")
    parser.add_argument("--model", default="qwen3-8b", help="Running Xinference model uid.")
